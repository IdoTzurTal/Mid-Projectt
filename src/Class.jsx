...
function Class() {
  ...
  return (
    <div>
      ...
      <span id="officeinfo">
        Elevated, move-in ready private workspace for teams of 20 or more.
        <br />
        Private amenities can include interior offices, meeting rooms, lounges,
        pantries.
        <br /> and more Customise your workspace with a suite of office add-ons,
        finishes and enhancements.
      </span>
      <span id="availability">Check availability now!</span>
      <span id="availabilitydescription">
        Use the calendar to select a timeframe and we will let you know if it's
        available.
      </span>
      <div id="cancellation">
        ...
        <ul>
          ...
          <li>
            ...
            are nonrefundable.
            <br /> If I am unable to attend I understand that I can transfer to
            a friend.
          </li>
        </ul>
      </div>
